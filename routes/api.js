...
router.get('/random/quotes', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/randomquotes`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/tahlil', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/dataTahlil.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/wirid', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/dataWirid.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/ayatkursi', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/dataAyatKursi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/doaharian', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/dataDoaHarian.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/bacaanshalat', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/dataBacaanShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshalat', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/dataNiatShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshubuh', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/NiatShubuh.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatdzuhur', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/NiatDzuhur.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatmaghrib', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/NiatMaghrib.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatisya', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/NiatIsya.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatashar', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/ardhixsquerpants/My-SQL-Results/main/data/NiatAshar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/asmaulhusna', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/random/asmaulhusna`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/info/wikipedia', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/wiki?q=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilih', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/vokal/hilih?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/halah', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/vokal/halah?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/huluh', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/vokal/huluh?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/heleh', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/vokal/heleh?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/holoh', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/vokal/holoh?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/music/chordlagu', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/chord?q=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/info/covidindo', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/corona`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/info/covidworld', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/covid19`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/anime/kusonime', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/kuso?q=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/spam/call', async (req, res, next) => {
	...
	if(!nomor) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter nomor"})
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/spamcall?no=${nomor}`))
        .then(response => response.json())
        .then(data => {
        var logs = data;
             res.json({
...
router.get('/random/hentai', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/hentai`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/trapnime', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(res.sendFile(invalidKey))
	if(listkey.includes(Apikey)){

       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/trapnime`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/nekonime', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/nekonime`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/blowjob', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(res.sendFile(invalidKey))
	if(listkey.includes(Apikey)){

       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/blowjob`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/textpro/impressive-glitch', async(req, res, next) => {
  const apikey = req.query.apikey;
  const text = req.query.text;
...
router.get('/textpro/logo-joker', async(req, res, next) => {
  const apikey = req.query.apikey;
  const text = req.query.text;
...
router.get('/textpro/3d-golden-ancient', async(req, res, next) => {
  const apikey = req.query.apikey;
  const text = req.query.text;
...
router.get('/textpro/devil-wings', async(req, res, next) => {
  const apikey = req.query.apikey;
  const text = req.query.text;
...
router.get('/textpro/bear-mascot', async(req, res, next) => {
  const apikey = req.query.apikey;
  const text = req.query.text;
...
router.get('/nsfw/hentong', async (req, res, next) => {
          var apikey = req.query.apikey
...
router.get('/nulis', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/nulis?text=${teks}`))
        .then(response => response.json())
        .then(data => {
        var results = data;
             res.json({
...
router.get('/info/mediafire', async (req, res, next) => {
        var Apikey = req.query.apikey,
            url = req.query.url
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://ardhixsquerpants.herokuapp.com/api/mediafire?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var detail = data;
             res.json({
